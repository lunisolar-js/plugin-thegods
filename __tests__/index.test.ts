...
import { theGods, TheGods } from '../src/index'
import zhCn from '../src/locale/zh-cn'
import theGodzhCn from '../src/locale/zh-cn'
import { commonActsStr, emperorActsStr, civilActsStr, defaultActsStr } from '../src/actData'
...
describe('plugins/theGods duty12God', () => {
  it('2022-08-16', () => {
    const lsr = lunisolar('2022-08-16')
    expect(lsr.theGods.getDuty12God().toString()).toBe('執')
  })
  it('2022-08-25', () => {
    const lsr = lunisolar('2022-08-25')
...
describe('plugins/theGods life12God', () => {
  it('2022-09-28', () => {
    const lsr = lunisolar('2022-09-28')
    expect(lsr.theGods.getLife12God('day').name).toBe('絕')
  })
  it('2022-09-29', () => {
    const lsr = lunisolar('2022-09-29')
    expect(lsr.theGods.getLife12God('day').name).toBe('絕')
  })
  it('2022-09-30', () => {
    const lsr = lunisolar('2022-09-30')
    expect(lsr.theGods.getLife12God('day').name).toBe('墓')
  })
  it('2022-10-01', () => {
    const lsr = lunisolar('2022-10-01')
    expect(lsr.theGods.getLife12God('day').name).toBe('胎')
  })
  it('2022-10-2', () => {
    const lsr = lunisolar('2022-10-2')
    expect(lsr.theGods.getLife12God('day').name).toBe('胎')
  })
  it('2022-10-3', () => {
    const lsr = lunisolar('2022-10-3')
    expect(lsr.theGods.getLife12God('day').name).toBe('墓')
  })
  it('2022-10-4', () => {
    const lsr = lunisolar('2022-10-4')
    expect(lsr.theGods.getLife12God('day').name).toBe('絕')
  })
  ...
  describe('plugins/theGods 神煞', () => {
    it('2022-10-19', () => {
      // 壬寅年 庚戌月 乙巳日
      const lsr = lunisolar('2022-10-19')
      // 年神
    ...
    it('2022-10-21', () => {
      // 壬寅 庚戌 丁未 庚子
      const lsr = lunisolar('2022-10-21', { lang: 'zh-cn' })
      // 年神
